...
@customElement("bb-whirlpool-galaxy")
export class BbWhirlpoolGalaxy extends BeautifulBackground {
    @property({ type: Number, attribute: "particle-force" })
    particleForce: number = 20;
...
declare global {
    interface HTMLElementTagNameMap {
        "bb-whirlpool-galaxy": BbWhirlpoolGalaxy;
    }
}
